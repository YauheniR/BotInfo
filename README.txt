# BotInfo
My first python project. Optimizes work with the client for the delivery of goods. Reads html files in the directory and converts them to the format:
Client name.
Client's phone number.
A link in the navigator to the client's location.
